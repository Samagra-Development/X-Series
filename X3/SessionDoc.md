...
_Pre-Requisite_ 
*__Please refer this [link](https://www.metabase.com/docs/latest/users-guide/02-database-basics.html) for a basic refresher on database basics.__*
...
- Steps Involved:
  ...
  - It is very important to pick aggregation unit for line charts, like for a span of 3000 days, you cannot plot the data at time interval of minutes. To do so, Click on the green Summarize button to pull up the Summarize sidebar, then group the 
